...
public class Mating extends Post {
    private Animal animal;
    private Location location;
    // Parameterized constructor

    public Mating(Animal animal, Location location, String title, String description, String name, String email, String phone) {
    ...
    public String toString() {
        return "Mating{"+"Title:"+super.getTitle()+"\n"+
